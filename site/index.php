...
<body>
  ...
  <!-- Cover -->
  <div class="bg-light pt-5" id="inicio" style="	background-image: url(&quot;img/bg2.png&quot;), url(&quot;img/bg4.jpg&quot;);	background-position: center, left top;	background-size: cover, cover;	background-repeat: no-repeat, no-repeat;">
    <div class="container pt-5 pb-4">
      <div class="row">
        <div class="text-lg-left text-left align-self-left pt-4 col-md-6 py-3" style="">
		  ...
		  <br>
          <a class="btn btn-lg btn-primary" href="http://cheguei.delivery/clientedemo/" target="blank"><b>Ver demostração</b></a>
        </div>
        ...
        <div class="col-lg-4 p-3">
          <div class="card">
            <div class="card-body p-4"> <img class="img-fluid d-block mb-3 mx-auto" src="img/1.png" width="230">
              <p class="lead"><b>Cadastre seu estabelecimento e produtos grátis por 20 dias</b></p>
    ...
    <div class="container">
      <div class="row">
        <div class="text-center col-md-12">
         ...
         <p>+ de 250 negócios já estão usando em todo o Brasil</p>
        </div>
      </div>
      <div class="row">
          ...
          <div class="accordion" id="faqExample">
            <div class="card">
              ...
              <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#faqExample">
                <div class="card-body"> Não, com nossa plataforma você terá uma URL exemplo: (<?=$dadosgerais->urlsite;?>/suaempresa) mas você pode optar por comprar um domínio próprio, exemplo: seudelivery.com e apontar para nosso servidor.</div>
              </div>
            </div>
            <div class="card">
