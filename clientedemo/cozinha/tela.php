...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row row-sm mg-t-20">
          ...
          <div class="col-lg-12 mg-b-20">
            <div class="card card-info pedido" data-timestamp="<?= strtotime($pedidossx->hora); ?>">
    ...
    $(function(){
        ...
        function updatePedidoColors() {
            var now = Math.floor(Date.now() / 1000);
            $('.pedido').each(function() {
                var pedidoTimestamp = $(this).data('timestamp');
                var diff = now - pedidoTimestamp;
                var color;
                if (diff < 900) {
                    color = '#00FF00'; // Verde
                } else if (diff < 1800) {
        ...
        setInterval(updatePedidoColors, 60000); // Atualiza a cada minuto
        updatePedidoColors(); // Atualiza ao carregar a página
