			...
			<div class="card card-info">
						...
						<div class="row" align="justify">
							<div class="col-md-3">
								<div class="form-group">
									Fundo do Menu: 
									<input type="color" class="form-control" name="cormenu" value="<?php print $dadoscat->cormenu; ?>" required>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									Fundo do sistema:
									<input type="color" class="form-control" name="corfundo" value="<?php print $dadoscat->corfundo; ?>" required>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									Rodapé:
									<input type="color" class="form-control" name="corrodape" value="<?php print $dadoscat->corrodape; ?>" required>
								</div>
							</div>
							<div class="col-md-3">
								<div class="form-group">
									Cor Carrinho:
									<input type="color" class="form-control" name="corcarrinho" value="<?php print $dadoscat->corcarrinho; ?>" required>
								</div>
				</div>
