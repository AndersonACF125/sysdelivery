		   ...
		   <div class="col-lg-12">
			   <div class="card card-info">
				   <div class="card-body pd-40">
					   <div class="row">
					   <div class="col-md-3" ></a>
									<img src="../img/fb.png" width="210" class="img-thumbnail"/>
								</div>
						   <div class="col-md-9" align="justify">
							   <br>
							   <span style="font-size:18px"><i class="fa fa-qrcode" aria-hidden="true"></i> SEU PIXEL DO FACEBOOK</span><br><br>
							   <span>seu Pixel do Facebook está configura e integrado.</span><br><br>
							   <!-- Meta Pixel Code -->
<script>
...
fbq('init', '1677350183066974');
fbq('track', 'PageView');
</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1677350183066974&ev=PageView&noscript=1"
/></noscript>
<!-- End Meta Pixel Code -->
